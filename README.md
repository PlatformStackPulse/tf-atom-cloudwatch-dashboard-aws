...
[![CI](https://github.com/PlatformStackPulse/tf-atom-cloudwatch-dashboard-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-cloudwatch-dashboard-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS CloudWatch Dashboard - creates a monitoring dashboard.
...
|------|-------------|------|---------|:--------:|
| <a name="input_dashboard_body"></a> [dashboard\_body](#input\_dashboard\_body) | JSON body of the dashboard | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the dashboard |
